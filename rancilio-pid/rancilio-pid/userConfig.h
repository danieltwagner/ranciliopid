...
// Display
#define DISPLAY 1                  // 0 = deactivated, 1 = SH1106 (e.g. 1.3 "128x64), 2 = SSD1306 (e.g. 0.96" 128x64)
...
#define D_SSID "TALKTALK995727"
#define PASS "YGRY6R7Y"
...
// BLynk
#define AUTH "hoktCjrxu_NZvFOY86iFZYON8Yi-tEvm"
...
#define PINBREWSWITCH 15           // 0: A0 (ESP8266) ; >0 : DIGITAL PIN, ESP32 OR ESP8266: ONLY USE PIN15 AND PIN16! 
...
#define PINETRIGGER 17             // PIN for E-Trigger relay
#define STEAMONPIN 16              // STEAM active
